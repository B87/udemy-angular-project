...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Eo="__SANITIZER_TRUSTED_BRAND__";function ko(e,t){return e instanceof String&&e[Eo]===t}function Oo(e,t){var n=new String(e);return n[Eo]=t,n}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Ho=e.SecurityContext||(e.SecurityContext={}))[Ho.NONE=0]="NONE",Ho[Ho.HTML=1]="HTML",Ho[Ho.STYLE=2]="STYLE",Ho[Ho.SCRIPT=3]="SCRIPT",Ho[Ho.URL=4]="URL",Ho[Ho.RESOURCE_URL=5]="RESOURCE_URL";var ii=function ii(){},ai=new RegExp("^([-,.\"'%_!# a-zA-Z0-9]+|(?:(?:matrix|translate|scale|rotate|skew|perspective)(?:X|Y|3d)?|(?:rgb|hsl)a?|(?:repeating-)?(?:linear|radial)-gradient|(?:calc|attr))\\([-0-9.%, #a-zA-Z]+\\))$","g"),ui=/^url\(([^)]+)\)$/;
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function si(e){if(!(e=String(e).trim()))return"";var t=e.match(ui);return t&&So(t[1])===t[1]||e.match(ai)&&function n(e){for(var t=!0,n=!0,r=0;r<e.length;r++){var o=e.charAt(r);"'"===o&&n?t=!t:'"'===o&&t&&(n=!n)}return t&&n}(e)?e:(No()&&console.warn("WARNING: sanitizing unsafe style value "+e+" (see http://g.co/ng/security#xss)."),"unsafe")}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function li(t){var n=gi();return n?n.sanitize(e.SecurityContext.HTML,t)||"":ko(t,"Html")?t.toString():ri(document,kn(t))}function ci(t){var n=gi();return n?n.sanitize(e.SecurityContext.STYLE,t)||"":ko(t,"Style")?t.toString():si(kn(t))}function fi(t){var n=gi();return n?n.sanitize(e.SecurityContext.URL,t)||"":ko(t,"Url")?t.toString():So(kn(t))}function di(t){var n=gi();if(n)return n.sanitize(e.SecurityContext.RESOURCE_URL,t)||"";if(ko(t,"ResourceUrl"))return t.toString();throw new Error("unsafe value used in a resource URL context (see http://g.co/ng/security#xss)")}function pi(t){var n=gi();if(n)return n.sanitize(e.SecurityContext.SCRIPT,t)||"";if(ko(t,"Script"))return t.toString();throw new Error("unsafe value used in a script context")}function hi(e,t){return"src"===t&&("embed"===e||"frame"===e||"iframe"===e||"media"===e||"script"===e)||"href"===t&&("base"===e||"link"===e)?di:fi}function vi(e,t,n){return hi(t,n)(e)}var yi=function(e,t,n){var r=!0;return 1&(n=n||3)&&(r="background-image"===e||"background"===e||"border-image"===e||"filter"===e||"list-style"===e||"list-style-image"===e||"clip-path"===e),2&n?r?ci(t):t:r};function gi(){var e=Mr();return e&&e[Kn]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function ki(e){var t=wr(e);if(t){if(Array.isArray(t)){var n=t,r=void 0,o=void 0,i=void 0;if(function a(e){return e&&e.constructor&&e.constructor.ngComponentDef}(e)){if(-1==(r=ji(n,e)))throw new Error("The provided component was not found in the application");o=e}else if(function u(e){return e&&e.constructor&&e.constructor.ngDirectiveDef}(e)){if(-1==(r=function s(e,t){for(var n=e[Vn].firstChild;n;){for(var r=n.directiveEnd,o=n.directiveStart;o<r;o++)if(e[o]===t)return n.index;n=Di(n)}return-1}(n,e)))throw new Error("The provided directive was not found in the application");i=Ai(r,n,!1)}else if(-1==(r=Ni(n,e)))return null;var l=wr(y=ur(n[r])),c=l&&!Array.isArray(l)?l:Oi(n,r,y);if(o&&void 0===c.component&&(c.component=o,Pi(c.component,c)),i&&void 0===c.directives){c.directives=i;for(var f=0;f<i.length;f++)Pi(i[f],c)}Pi(c.native,c),t=c}}else for(var d=e,p=d;p=p.parentNode;){var h=wr(p);if(h){if(n=void 0,!(n=Array.isArray(h)?h:h.lView))return null;var v=Ni(n,d);if(v>=0){var y;Pi(y=ur(n[v]),c=Oi(n,v,y)),t=c;break}}}return t||null}function Oi(e,t,n){return{lView:e,nodeIndex:t,native:n,component:void 0,directives:void 0,localRefs:void 0}}function Ti(e){var t,n=wr(e);if(Array.isArray(n)){var r=ji(n,e);(o=Oi(n,r,(t=vr(r,n))[Rn])).component=e,Pi(e,o),Pi(o.native,o)}else{var o;t=vr((o=n).nodeIndex,o.lView)}return t}function Pi(e,t){e[ar]=t}function Ni(e,t){for(var n=e[Vn].firstChild;n;){if(dr(n,e)===t)return n.index;n=Di(n)}return-1}function Di(e){if(e.child)return e.child;if(e.next)return e.next;for(;e.parent&&!e.parent.next;)e=e.parent;return e.parent&&e.parent.next}function ji(e,t){var n=e[Vn].components;if(n)for(var r=0;r<n.length;r++){var o=n[r];if(vr(o,e)[Un]===t)return o}else if(vr(er,e)[Un]===t)return er;return-1}function Ai(e,t,n){var r=t[Vn].data[e],o=r.directiveStart;return 0==o?tn:(!n&&1&r.flags&&o++,t.slice(o,r.directiveEnd))}var Si=function(){function e(){this._players=[]}return e.prototype.flushPlayers=function(){for(var e=0;e<this._players.length;e++){var t=this._players[e];t.parent||0!==t.state||t.play()}this._players.length=0},e.prototype.queuePlayer=function(e){this._players.push(e)},e}(),Ri=0,Vi="@";
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Gi(e){return e!==Ci}function Ji(e){return 32767&e}function Yi(e){return e>>16}function $i(e,t){for(var n=Yi(e),r=t;n>0;)r=r[$n],n--;return r}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Xi(e){var t=e[Fn];return lr(t)?t[Fn]:t}function ea(e){for(var t=e[Bn];null!==t&&2===t.type;)t=(e=e[$n])[Bn];return e}function ta(e){return function t(e){for(var t=sr(e)?e:br(e);t&&!(512&t[Mn]);)t=Xi(t);return t}(e)[Un]}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function Oa(e){try{return null!=e?e.toString().slice(0,30):e}catch(e){return"[ERROR] Exception while trying to serialize the value"}}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Du="ng-template";function ju(e,t){var n=e.length,r=e.indexOf(t),o=r+t.length;return!(-1===r||r>0&&" "!==e[r-1]||o<n&&" "!==e[o])}function Au(e,t,n){return t===(0!==e.type||n?e.tagName:Du)}function Su(e,t,n){for(var r=4,o=e.attrs||[],i=function a(e){for(var t=0;t<e.length;t++)if(Ki(e[t]))return t;return e.length}(o),u=!1,s=0;s<t.length;s++){var l=t[s];if("number"!=typeof l){if(!u)if(4&r){if(r=2|1&r,""!==l&&!Au(e,l,n)||""===l&&1===t.length){if(Ru(r))return!1;u=!0}}else{var c=8&r?l:t[++s];if(8&r&&e.stylingTemplate){if(!ju(Vu(e),c)){if(Ru(r))return!1;u=!0}continue}var f=Mu(8&r?"class":l,o,0==e.type&&e.tagName!==Du,n);if(-1===f){if(Ru(r))return!1;u=!0;continue}if(""!==c){var d;d=f>i?"":o[f+1];var p=8&r?d:null;if(p&&!ju(p,c)||2&r&&c!==d){if(Ru(r))return!1;u=!0}}}}else{if(!u&&!Ru(r)&&!Ru(l))return!1;if(u&&Ru(l))continue;u=!1,r=l|1&r}}return Ru(r)||u}function Ru(e){return 0==(1&e)}function Vu(e){return e.stylingTemplate?ku(e.stylingTemplate):""}function Mu(e,t,n,r){if(null===t)return-1;var o=0;if(r||!n){for(var i=!1;o<t.length;){var a=t[o];if(a===e)return o;if(3===a||6===a)i=!0;else{if(1===a){for(var u=t[++o];"string"==typeof u;)u=t[++o];continue}if(4===a)break;if(0===a){o+=4;continue}}o+=i?1:2}return-1}return function s(e,t){var n=e.indexOf(4);if(n>-1)for(n++;n<e.length;){if(e[n]===t)return n;n++}return-1}(t,e)}function Fu(e,t,n){void 0===n&&(n=!1);for(var r=0;r<t.length;r++)if(Su(e,t[r],n))return!0;return!1}function Hu(e,t){e:for(var n=0;n<t.length;n++){var r=t[n];if(e.length===r.length){for(var o=0;o<e.length;o++)if(e[o]!==r[o])continue e;return!0}}return!1}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */var Lu,Bu={marker:"element"},Qu={marker:"comment"},zu=0;function Uu(){return zu>0}function Zu(e){Lu=e}function qu(){return Lu}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
